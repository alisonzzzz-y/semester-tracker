...
const App = () => {
      ...
      if (needsReset) {
        ...
        if (lastResetDate && data.weeklyScore > 0) {
          ...
          const lastWeekTasks = (data.tasks || []).filter((t) => {
            ...
            return (
              taskDate >= lastMonday && taskDate <= lastSunday && t.completed
            );
          });
  ...
  useEffect(() => {
    const saved = localStorage.getItem("semesterTracker");
    const lastResetDate = saved
      ? JSON.parse(saved).lastWeeklyReset
  ...
  const getCategoryStats = () => {
    return Object.entries(categories).map(([name, data]) => ({
      ...
      points: tasks
        .filter((t) => t.category === name && t.completed)
        .reduce((sum, t) => sum + t.score, 0),
    }));
  };
    ...
    >
      ...
      {showScoreAnimation && (
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 score-animation pointer-events-none">
          <div
            ...
            style={{ color: categories[showScoreAnimation.category].color }}
          >
      ...
      <div className="px-12 py-4">
        <div className="max-w-[1100px] mx-auto flex items-center justify-between">
          ...
          <div
            className="flex gap-2 rounded-full p-1.5"
            style={{
          ...
          >
            {[
              ...
              <button
                ...
                style={{
                  backgroundColor:
                    view === key ? "rgba(139, 92, 246, 0.15)" : "transparent",
  ...
  <div className="space-y-6">
    <div className="rounded-2xl p-8" style={{ backgroundColor: "#1c1c1e" }}>
      ...
      <div className="space-y-4">
          ...
          <input
            ...
            onFocus={(e) =>
              (e.currentTarget.style.boxShadow =
                "inset 0 1px 3px rgba(0,0,0,0.3), 0 0 0 2px rgba(139, 92, 246, 0.5)")
            }
            onBlur={(e) =>
              (e.currentTarget.style.boxShadow =
        ...
        <div className="flex flex-wrap gap-2" style={{ isolation: 'isolate' }}>
          {Object.entries(categories).map(([name, data]) => (
            <button
              ...
              style={{
                backgroundColor:
                  selectedCategory === name ? "#2a2a2a" : "#222222",
                color: selectedCategory === name ? "#fff" : "#d1d1d1",
                boxShadow:
                  selectedCategory === name ? "0 0 0 2px #8b5cf6" : "none",
              }}
            >
              {data.icon} {name}{" "}
              <span style={{
                ...
                {data.fixed ? `+${data.score}` : `+${customScore}`}
              </span>
            </button>
          ))}
        </div>
              ...
              <div className="flex-1">
                ...
                >
                  {Array.from(
                    {
                      length:
                        (categories[selectedCategory].max || 8) -
                        (categories[selectedCategory].min || 3) +
                        1,
                    },
                    (_, i) => (
                      <span key={i}>
                        {(categories[selectedCategory].min || 3) + i}
                      </span>
                    ),
                  )}
                </div>
    ...
    <div className="grid grid-cols-4 gap-4">
      {[
        ...
        <div
          key={idx}
          className="rounded-2xl p-8 transition-colors duration-150"
        ...
        >
          ...
          <div className="text-[56px] font-bold leading-none mb-4">
            {typeof stat.value === "string" && stat.value.includes("/") ? (
              <>
                {stat.value.split("/")[0]}
                <span className="text-2xl" style={{ color: "#8a8a8a" }}>
                  /{stat.value.split("/")[1]}
                </span>
              </>
            ) : (
      ...
      {getTodayTasks().length === 0 ? (
        <div className="text-center py-16">
          <Target
            ...
            style={{ color: "#555555" }}
          />
          <p className="text-lg mb-2" style={{ color: "#d1d1d1" }}>
            No tasks for today
          </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div
                    ...
                    style={{ color: task.completed ? "#8a8a8a" : "#fff" }}
                  >
                    {task.text}
                  </div>
                  <div
    ...
    <div className="rounded-2xl p-8" style={{ backgroundColor: "#1c1c1e" }}>
      ...
      {getWeekTasks().length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-sm" style={{ color: "#8a8a8a" }}>
            Add some tasks to build momentum
          </p>
        </div>
      ) : (
        <div className="space-y-2">
      ...
      <div className="grid gap-6" style={{ gridTemplateColumns: "2fr 1fr" }}>
        <div className="rounded-2xl p-6" style={{ backgroundColor: "#1c1c1e" }}>
          <div className="flex items-center mb-5 gap-4">
            <h2 className="text-2xl font-bold whitespace-nowrap truncate flex-1 min-w-0">
          ...
          >
            {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day) => (
              <div
                key={day}
                className="text-center text-xs font-semibold pb-3 uppercase tracking-wider"
                style={{ color: "#8a8a8a" }}
              >
                {day}
              </div>
            ...
            {getDaysInMonth().map((date, idx) => {
              ...
              return (
                <button
                  ...
                  className="h-16 rounded-lg p-1.5 relative transition-all duration-150"
                  style={{
                ...
                >
                  <div
                    className="absolute top-1.5 left-1.5 text-sm font-semibold"
                    style={{
                      color: isToday && !isSelected ? "#8b5cf6" : "#fff",
                    }}
                  >
                    {date.getDate()}
                  </div>
                      ...
                      {hasCompletedTasks && (
                        <div
                          ...
                          style={{
                            backgroundColor:
                              categories[
                                dayTasks.find((t) => t.completed)?.category
                              ]?.color || "#00D9FF",
                          }}
                        />
                      )}
        ...
        <div
          ...
          style={{ backgroundColor: "#1c1c1e", width: "100%" }}
        >
          ...
          {getTasksForDate(selectedDate).length > 0 && (
            <div
              className="grid grid-cols-3 gap-3 mb-6 p-4 rounded-xl flex-shrink-0"
              style={{ backgroundColor: "#222222" }}
            >
              <div>
...
const StatsView = ({
  ...
  <div className="space-y-6">
    <div className="grid grid-cols-4 gap-4">
      ...
      <div className="rounded-2xl p-8" style={{ backgroundColor: "#1c1c1e" }}>
        <div
          className="text-[56px] font-bold leading-none mb-2"
          style={{ color: "#00D9FF" }}
        >
      ...
      <div className="space-y-6">
        {getCategoryStats().map((cat) => {
          ...
          const maxCompleted = Math.max(
            ...getCategoryStats().map((c) => c.completed),
            1,
          );
    ...
    <div className="rounded-2xl p-10" style={{ backgroundColor: "#1c1c1e" }}>
      ...
      <div className="grid grid-cols-10 gap-2.5">
        {getCalendarData().map((day, idx) => {
          const intensity =
            day.score > 0 ? Math.min((day.score / 20) * 100, 100) : 0;
          return (
            <div
              key={idx}
      ...
      >
        ...
        <div className="flex gap-1.5">
          ...
          <div
            className="w-5 h-5 rounded-md"
            style={{ background: "rgba(0, 217, 255, 1)" }}
          ></div>
        </div>
        <span>More</span>
      </div>
...
const WeeklyChart = ({ data }) => {
  ...
  return (
    <div className="relative h-80">
      {hoveredIndex !== null && (
        <div
          className="absolute top-4 left-1/2 -translate-x-1/2 px-4 py-3 rounded-xl shadow-xl z-10"
          style={{ backgroundColor: "#2a2a2a", border: "1px solid #222222" }}
        >
          ...
          <div className="text-xs" style={{ color: "#d1d1d1" }}>
            {data[hoveredIndex].tasks} tasks
          </div>
        </div>
      )}
      ...
      <svg width="100%" height={h} viewBox={`0 0 ${w} ${h}`}>
        ...
        <text x="30" y="20" fill="#8a8a8a" fontSize="11" fontWeight="500">
          pts
        </text>
